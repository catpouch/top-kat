...
Python bindings to the `streaming_algorithms <https://docs.rs/streaming_algorithms/latest/streaming_algorithms/>`_ Rust crate. Includes the following algorithms:
